...
train_data_path <- file.path(wd, "processed_data", "pca_train_data_2d.csv")
...
# Load test data
test_data_path <- file.path(wd, "processed_data", "pca_test_data_2d.csv")
...
loo_data_path <- file.path(wd, "processed_data", "pca_loo_data_2d.csv")
