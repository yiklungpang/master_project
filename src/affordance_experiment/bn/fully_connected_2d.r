...
affordance.dag = empty.graph(nodes = c("tool_squareness", "tool_symmetry", "tool_convexity", "tool_eccentricity",
                                       "obj_circleness",
                                       "action", "effect_X", "effect_Y"))
# Definine the directions
amat(affordance.dag) = matrix(c(0L, 0L, 0L, 0L, 0L, 0L, 1L, 1L,
                                ...
                                0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L),
                              byrow = TRUE, nrow = 8, ncol = 8, dimnames = list(nodes(affordance.dag), nodes(affordance.dag)))
# Plot the BN
